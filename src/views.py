...
def get_info_by_request(request_date, file_data="../data/output.json"):
    ...
    dict_hi = {}
    dict_hi["greeting"] = get_current_time()  # Запись приветствия в файл JSON
    ...
    with open(file_data, "r", encoding="utf-8") as f:  # Чтение итогового файла JSON со всеми данными
